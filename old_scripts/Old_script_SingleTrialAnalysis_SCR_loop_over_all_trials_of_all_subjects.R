...
# Load logfiles
logfiles <- list.files("C:/Users/Luisa/PhD/1_PhD_Project/6_ModERN_Behavioral_Study/6_Raw_Data_behav")       # lists files in folder
setwd("C:/Users/Luisa/PhD/1_PhD_Project/6_ModERN_Behavioral_Study/6_Raw_Data_behav")                        # path to folder containing the log files (use of forward slashes instead of backward slashes is required); should contain ONLY logfiles 
...
scrfiles <- list.files("C:/Users/Luisa/PhD/1_PhD_Project/6_ModERN_Behavioral_Study/9_SCR_export_preprocessed") 
...
for (number in unique(master$number)){
 ...
 mean_SCR_after_FA <- mean(singleID_SCR[(singleID_SCR$t_resp == 43 | singleID_SCR$t_resp == 44) & (singleID_SCR$w_resp == 51 | singleID_SCR$w_resp == 52),]$DDA.AMP.z_scorelog,na.rm=TRUE)
 mean_SCR_after_FH <- mean(singleID_SCR[(singleID_SCR$t_resp == 41) & (singleID_SCR$w_resp == 51 | singleID_SCR$w_resp == 52),]$DDA.AMP.z_scorelog,na.rm=TRUE)
 mean_SCR_after_CI <- mean(singleID_SCR[(singleID_SCR$t_resp == 45 | singleID_SCR$t_resp == 46) & (singleID_SCR$w_resp == 51 | singleID_SCR$w_resp == 52),]$DDA.AMP.z_scorelog,na.rm=TRUE)
 mean_SCR_after_SH <- mean(singleID_SCR[(singleID_SCR$t_resp == 42) & (singleID_SCR$w_resp == 51 | singleID_SCR$w_resp == 52),]$DDA.AMP.z_scorelog,na.rm=TRUE)
 ...
 #write.foreign(as.data.frame(df4save), "C:/Users/Luisa/PhD/1_PhD_Project/6_ModERN_Behavioral_Study/5_Analyses/data4save.txt", "C:/Users/Luisa/PhD/1_PhD_Project/6_ModERN_Behavioral_Study/5_Analyses/df4save.sps", package="SPSS")
 ...
 setwd("C:/Users/Luisa/PhD/1_PhD_Project/6_ModERN_Behavioral_Study")
