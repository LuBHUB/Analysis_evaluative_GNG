...
* For the GNG RT, the maximal model containing all random slopes, intercept and correlations of these converged and had the best fit.
...
LMM_rt_gng_final_summary <- summary(LMM_rt_gng_final)   # model does converge -> identified model
kable(LMM_rt_gng_final_summary$coefficients, caption = "Overview Fixed Effects LMM GNG RT") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"), font_size = 10, full_width = F, position = "left")
```
