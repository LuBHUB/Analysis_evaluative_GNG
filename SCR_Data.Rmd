...
df_aggregated_over_subjects$response_type <- factor(substr(df_aggregated_over_subjects$condition, 11, 12), levels=c("FA","FH","SH"))
...
df_aggregated_over_subjects_resptype$response_type <- factor(df_aggregated_over_subjects_resptype$response_type, levels=c("FA","FH","SH"))
...
tab_model(LMM_scr_no_val_final,dv.labels = "SCR [square root and z transformed (µS)]", pred.labels = pl,wrap.labels = 60, show.stat = TRUE, show.se = TRUE, string.se = "SE", show.loglik = TRUE, show.dev = TRUE, show.re.var = FALSE, show.ngroups = FALSE, show.icc = FALSE, show.r2 = FALSE)
```
<br>
<br>
...
# ggplot(data=df_aggregated_scr_response_type, aes(x=response_type, y = iscr_gng_resp_sqrt_z_score))+geom_point()+facet_wrap(~subjectID)+theme_bw()+ ggtitle("Skin Conductance Response per Subject") + theme(plot.title = element_text(hjust = 0.5)) + ylab("SCR [square root and z transformed (µS)]")
```
<br>
...
kable(table_scr, caption = 'SCR [square root and z transformed (µS)]') %>% 
...
table_scr_val <- table_scr_val[,c(1,4,2,5,3,6)]
...
As in all other analyses on SCR data, I only included FA, FH, SH trials that had no invalid gng rt or word rt (these trials were consistently excluded for all analyses), were followed by correct word classification and were not preceded or followed by an incorrect response or wrong key in gng or word classification.
...
tab_model(LMM_rt_scr_final, order.terms = c(1,7,9,6,3,2,8,11,4,10,5,12), dv.labels = "RT [-1000/RT(ms)]] Word Categorization", pred.labels = pl,wrap.labels = 60, show.stat = TRUE, show.se = TRUE, string.se = "SE", show.loglik = TRUE, show.dev = TRUE, show.re.var = FALSE, show.ngroups = FALSE, show.icc = FALSE, show.r2 = FALSE)
```
...
tab_model(LMM_rt_scr_nested, order.terms = c(1,2,3,7,8,9,10,11,12,4,5,6), dv.labels = "RT [-1000/RT(ms)]] Word Categorization", pred.labels = pl,wrap.labels = 60, show.stat = TRUE, show.se = TRUE, string.se = "SE", show.loglik = TRUE, show.dev = TRUE, show.re.var = FALSE, show.ngroups = FALSE, show.icc = FALSE, show.r2 = FALSE)
```
...
tab_model(LMM_scr_final,order.terms = c(1,2,6,5,4,3), dv.labels = "SCR [square root and z transformed (µS)]", pred.labels = pl,wrap.labels = 60, show.stat = TRUE, show.se = TRUE, string.se = "SE", show.loglik = TRUE, show.dev = TRUE, show.re.var = FALSE, show.ngroups = FALSE, show.icc = FALSE, show.r2 = FALSE)
...
tab_model(LMM_scr_cross_clean,dv.labels = "SCR [square root and z transformed (µS)]", pred.labels = pl,wrap.labels = 60, show.stat = TRUE, show.se = TRUE, string.se = "SE", show.loglik = TRUE, show.dev = TRUE, show.re.var = FALSE, show.ngroups = FALSE, show.icc = FALSE, show.r2 = FALSE)
...
tab_model(LMM_scr_cross,order.terms = c(1,6,4,3,5,2), dv.labels = "SCR [square root and z transformed (µS)]", pred.labels = pl,wrap.labels = 60, show.stat = TRUE, show.se = TRUE, string.se = "SE", show.loglik = TRUE, show.dev = TRUE, show.re.var = FALSE, show.ngroups = FALSE, show.icc = FALSE, show.r2 = FALSE)
```
