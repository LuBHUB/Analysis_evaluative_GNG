...
I cannot evaluate effect of color of fixation cross in a convincing way. For doing this, I would need to include trials with white and red crosses that were only preceded and followed by white crosses. If I did this, only 1205 trials remain for the analysis. There, there indeed is a trend for the effect of color of fixation cross on SCR. The effect actually is significant if I remove the random slope (which should be done, as according to the *anova* function it does not improve the fit). But this analysis is based on a tiny subset of the original data and not representative.
