...
tab_model(LMM_scr_no_val_final,pred.labels = pl, show.stat = TRUE, show.se = TRUE, string.se = "SE", show.r2 = FALSE, show.re.var = FALSE, show.ngroups = FALSE, show.obs = FALSE, show.icc = FALSE, dv.labels = "SCR [sqrt(microsiemens)]")
```
<br>
<br>
...
tab_model(LMM_scr_final,pred.labels = pl, show.stat = TRUE, show.se = TRUE, string.se = "SE",  order.terms = c(1,2,6,5,4,3), show.r2 = FALSE, show.re.var = FALSE, show.ngroups = FALSE, show.obs = FALSE, show.icc = FALSE, dv.labels = "SCR [sqrt(microsiemens)] predicted by Response Type and Word Valence")
...
tab_model(LMM_rt_scr_final,pred.labels = pl, show.stat = TRUE, show.se = TRUE, string.se = "SE", show.r2 = FALSE, order.terms = c(1,2,3,7,8,9,10,11,12,4,5,6), show.re.var = FALSE, show.ngroups = FALSE, show.obs = FALSE, show.icc = FALSE, dv.labels = "RT [-1000/RT(ms)]] Word Categorization")
```
...
tab_model(LMM_rt_scr_nested,pred.labels = pl, show.stat = TRUE, show.se = TRUE, string.se = "SE", show.r2 = FALSE, order.terms = c(1,2,3,7,8,9,10,11,12,4,5,6), show.re.var = FALSE, show.ngroups = FALSE, show.obs = FALSE, show.icc = FALSE, dv.labels = "RT [-1000/RT(ms)]] Word Categorization")
```
