...
for (subject in scrfiles){                                                                              # loop reading csv-file
  ...
  colnames(scr_ordered) <-c("Event.Nr.Tar","Event.ID.Tar","Event.Name.Tar","DDA.nSCR.Tar","DDA.Latency.Tar","DDA.AmpSum.Tar","DDA.AreaSum.Tar","DDA.Tonic.Tar","TTP.nSCR.Tar","TTP.Latency.Tar","TTP.AmpSum.Tar","Global.Mean.Tar","Global.MaxDeflection.Tar","order.Tar",                                     
                            "Event.Nr.TarResp","Event.ID.TarResp","Event.Name.TarResp","DDA.nSCR.TarResp","DDA.Latency.TarResp","DDA.AmpSum.TarResp","DDA.AreaSum.TarResp","DDA.Tonic.TarResp","TTP.nSCR.TarResp","TTP.Latency.TarResp","TTP.AmpSum.TarResp","Global.Mean.TarResp","Global.MaxDeflection.TarResp","order.TarResp",                                    
