...
I also checked **error rate** as a covariate (only in the LMM). The 3-way interaction error_rate:valence:response_type did not improve the model fit. There is a main effect of error rate but no interaction with valence*response_type. Hence, the priming effect is not modulated by the error rate. When I include error rate as a covariate in the nested model, the priming effect after SH becomes a trend only (p = .09), the priming effect after FH and FA remain significant.
...
tab_model(LMM_rt_final,pred.labels = pl, show.stat = TRUE, show.se = TRUE, string.se = "SE", order.terms = c(1,2,6,3,7,4,8,5), show.r2 = FALSE, show.re.var = FALSE, show.ngroups = FALSE, show.obs = FALSE, show.icc = FALSE, dv.labels = "RT [-1000/RT(ms)]] Word Categorization")
```
<br>
...
(Akin to the ANOVA omnibus test, it can be tested whehter the interaction response type x valence improves the model fit significantly. It does. Thus, there is an omnibus interaction effect.) The interaction valence x response type was resolved in the next step.
...
tab_model(LMM_rt_nested,pred.labels = pl, show.stat = TRUE, show.se = TRUE, string.se = "SE", show.r2 = FALSE, show.re.var = FALSE, show.ngroups = FALSE, show.obs = FALSE, show.icc = FALSE, dv.labels = "RT [-1000/RT(ms)]] Word Categorization")
```
...
tab_model(GLMM_acc_final,pred.labels = pl, show.stat = TRUE, show.se = TRUE, string.se = "SE",  show.r2 = FALSE, show.re.var = FALSE, show.ngroups = FALSE, show.obs = FALSE, show.icc = FALSE, dv.labels = "Correctness of Word Categorization")
```
<br>
